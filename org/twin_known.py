...
if __name__ == '__main__':
    ...
    m_C = 13040.207 # 13040.202??

    m_xi = 1321.71;
    m1 = 9499.326 # 9499.323???
    m2 = 4839.943 # 4839.942???

    err_m_xi = 0.07;
    err_m1 = 0.22;
    err_m2 = 0.02;

    mom1 = 342.477 # 363.004???
    mom2 = 342.609 # 344.294???
    theta1 = np.deg2rad(136.2)
    theta2 = np.deg2rad(41.7)
    phi1 = np.deg2rad(13.3)
    phi2 = np.deg2rad(193.5)

    err_mom1 = 7.859
    err_mom2 = 0.953
    err_theta1 = np.deg2rad(11.87)#;//4.34;
    err_theta2 = np.deg2rad(5.29)#;//1.77;
    err_phi1 = np.deg2rad(12.00)#;//4.10;
    err_phi2 = np.deg2rad(5.34)#;//1.58;
